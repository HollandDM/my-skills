...
- **Workflow tool present** → read `${SKILL_DIR}/ultracode-mode.md` and follow it (deterministic background orchestration — per-phase implementers → bounded review/fix loop → single build → final review).
