...
from stepwise_pseudocode import presentation
...
def render_html(ledger: dict, *, title: str, exported_at: str, adrs: list[dict], review_key: str = "") -> str:
    ...
    payload = {"ledger": ledger, "title": title, "exported_at": exported_at, "adrs": adrs, "review_key": review_key, "pseudocode": presentation(ledger)}
    ...
    for marker, filename in [("__STEPWISE_PSEUDOCODE_JS__", "pseudocode-ui.js"), ("__STEPWISE_REVIEW_JS__", "review-ui.js"), ("__STEPWISE_BEHAVIOR_JS__", "behavior-ui.js"), ("__STEPWISE_EXISTING_JS__", "existing-ui.js")]:
