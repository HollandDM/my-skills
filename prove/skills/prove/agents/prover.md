...
After delivering initial argument, help fellow provers strengthen by messaging them directly. Can also ask for help:
...
Judges may message you asking follow-ups on specific steps in logic path. When a judge messages you:
