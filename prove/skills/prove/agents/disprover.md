...
When argument complete, **send your full argument to the team lead**.
...
After delivering initial argument, help fellow disprovers strengthen attacks by messaging them directly. Can also ask for help:
...
Judges may message you asking follow-ups on specific logic path steps. When a judge messages you:

- **Respond directly** to the judge who asked.
